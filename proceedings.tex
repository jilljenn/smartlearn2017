...
\def\plaintitle{Using Smartphones as Controllers for Turning Short Answers into Smart Multiple-Choice Questions via Crowdsourcing}
...
\begin{abstract}
  A variety of quiz-based games outsource the potential answers of some short-answer questions to the crowd (\emph{crowdsourcing}). Recent versions of these games use widespread hand devices as controllers, such as smartphones or tablets, which is a convenient way to present interactive applications. In this paper, we present a theoretical framework for studying such systems. We finally describe potential applications in learning.
\end{abstract}
