...
\def\plaintitle{Using Smartphones as Clickers for Turning Short Answers into Smart Multiple-Choice Questions via Crowdsourcing}
\def\plainauthor{Jill-Jênn Vie, Fabrice Popineau, Michel Blockelet}
\def\emptyauthor{}
...
\begin{abstract}
  UPDATED---\today. In this paper we propose an example of tool inspired from recent games.
\end{abstract}
...
Fictionary is a game where a master player says a word, and the other players have to suggest a fake but believable definition for this word. After this step, definitions from every player are displayed together, then players have to vote for the true definition. The goal is to fool the other players with one's suggestion.

Fibbage, Drawful. The smartphone is the controller.

Franck Silvestre has suggested an app where students have to vote for an answer and describe their level of confidence. After they pick an answer, another answer is displayed in their screen from another student who disagrees and is confident in their answer.

A direct application would be for spelling.
